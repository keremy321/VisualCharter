...
public class CreateJpegDataset {
    ...
    public CreateJpegDataset(String choose, String[] headers, String[][] data, String chartTitle, String xAxisLabel, String yAxisLabel)throws IOException {
        this.choose = choose;
        ...
        switch (choose) {
            case "Line Chart":
                ...
                ChartJpeg.LineChartJpeg(lineDataset, chartTitle, xAxisLabel, yAxisLabel);
                break;
            ...
            case "Bar Chart":
                ...
                ChartJpeg.BarChartJpeg(barDataset, chartTitle, xAxisLabel, yAxisLabel);
                break;
            ...
            case "Pie Chart":
                ...
                ChartJpeg.PieChartJpeg(pieDataset, chartTitle);
                break;
            ...
            case "Scatter Chart":
                ...
                ChartJpeg.ScatterChartJpeg(scatterDataset, chartTitle, xAxisLabel, yAxisLabel);
                break;
